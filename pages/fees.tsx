...
const ERC1155_contract_address = "0x6E20e00bf9FE4D78C51b84ffC458B60774F4f535";
...
const Home2: NextPage = () =>{
    const connect2 = async () => {
      if(typeof window !== "undefined" && window.ethereum){
        ...
        const estimatedGas = await myContract.estimateGas.mintFreeToken(accounts[0]);
        console.log("gaslimit", ethers.utils.formatUnits(estimatedGas, "wei"));
        const feeData = await baseProvider.getFeeData();
        const maxPriorityFeePerGas = feeData.maxPriorityFeePerGas;
        const maxFeePerGas = feeData.maxFeePerGas;
        console.log("Max priority fee per gas:", ethers.utils.formatUnits(maxPriorityFeePerGas, "gwei"));
        ...
        // console.log("sent:", mintTx);
        // const transactionReceipt = await baseProvider.waitFor(mintTx.hash);
        // console.log("finished: ",transactionReceipt);
      }
      else{
    ...
    return (
      <button onClick={ () => connect2 ()}>Click to connect</button>
    )
  } 
